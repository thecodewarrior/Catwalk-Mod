...
import com.thecodewarrior.catwalk.BlockContainerCustomHighlight;
import com.thecodewarrior.notmine.codechicken.lib.math.MathHelper;
import com.thecodewarrior.notmine.codechicken.lib.vec.BlockCoord;
...
public class RayTracer
{
    ...
    public static MovingObjectPosition retraceBlock(World world, EntityPlayer player, int x, int y, int z)
    {
        ...
        if(block instanceof BlockContainerCustomHighlight)
        	return ((BlockContainerCustomHighlight) block).collisionRayTrace(world, x, y, z, headVec, endVec, player);
        else
